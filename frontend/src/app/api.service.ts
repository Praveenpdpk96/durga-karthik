...
export interface SemanticMatchResponse extends MatchResponse { engine: string; summary: string; recommendations: string[]; }
...
export class ApiService {
  ...
  extractResume(file: File): Observable<ResumeDocument> {
    const data = new FormData(); data.append('file', file);
    return this.http.post<ResumeDocument>(`${this.baseUrl}/resumes/extract`, data);
  }
